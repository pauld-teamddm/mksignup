		...
		<div class="span6">
			<div class="well player <?=$divisionClass?>">
				...
				<p>
					...
					<span class="label label-success"><i class="icon-certificate icon-white"></i> <?=$player->preparePoints()?></span> <span class="label"><i class="icon-resize-small icon-white"></i> <?=$player->prepareMatches()?></span>
				</p>
